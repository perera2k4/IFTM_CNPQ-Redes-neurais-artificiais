"""
Classificação de Vinhos - Análise Multi-classe
Este script treina uma rede neural para classificar vinhos baseado em suas características.
...
def main():
    ...
    # Converter as classes (classe 2 -> 1, outras -> original)
