"""
Classificação de Vinhos - Classe 1
Este script treina uma rede neural para classificar vinhos, focando na classe 1.
...
def main():
    ...
    # Converter as classes - Classe 1 (classe 2 -> 1, outras -> original)
