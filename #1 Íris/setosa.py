"""
Classificação de flores Íris - Detecção de Setosa
Este script treina uma rede neural para classificar flores íris,
especificamente para detectar a classe Setosa.
"""
...
def main():
    ...
    # Converter as classes para detecção de Setosa
    # 0: setosa = 1; 1: versicolor = 0; 2: virginica = 0
